      ...
      <div className="container-custom text-[#483a83]">
        <div className="grid md:grid-cols-2 py-10 gap-8">
          <div className="py-4 px-4">
            ...
            <p className="text-sm">
              Email: tatigerzens@gmail.com <br />
            </p>
          </div>
          <div className="py-4 px-4">
        ...
        <div className="border-t border-gray-300 mt-8 p-4 text-center text-sm text-gray-500">
          © {new Date().getFullYear()} diseñado por Tatiana Gerzenstein.{" "}
        </div>
      </div>
    </div>
  );
